...
- Cancelling a plan (the logic behind the Cancel button), an upgrade or switch between monthly and yearly while active, and automatic renewal: not built; the Cancel button is wired to a placeholder that answers 501, and an active plan blocks a second checkout (409).
